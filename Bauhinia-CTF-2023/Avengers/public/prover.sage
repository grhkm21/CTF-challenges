...
class Protocol:
    ...
    def mystizes(self):
        return [self.yellman(), self.rkmx7()]
    ...
    def challenge(self):
        ...
        neobeo = self.matsub(msg1_r, forgores=[45, 4])

        msg2 = bytes.fromhex(input("john tate? ").strip())
        msg2_r = int.from_bytes(msg2, "big")
        имя_пользователя = self.matsub(msg2_r, forgores=[45, 4])
